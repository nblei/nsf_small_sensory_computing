...
ultra-low power microcontrollers~\cite{heller2019microwatt} and
GPUs~\cite{kersey2017lightweight}, as well as \(<\si{\milli\watt}\) spatial
...
computing~\cite{raychowdhury2005computing}. Thus the design space exploration
